...
typedef __type *vec3_t;
typedef __type *vec4_t;
typedef __type *mat3_t;
typedef __type *mat4_t;
typedef __type *quat_t;
 ...
 * dest if not NULL, vec otherwise
 */
vec3_t vec3_scale(vec3_t vec, __type val, vec3_t dest);
 ...
 */
__type vec3_dot(vec3_t vec, vec3_t vec2);
...
vec3_t vec3_lerp(vec3_t vec, vec3_t vec2, __type lerp, vec3_t dest);
 ...
 */
__type vec3_dist(vec3_t vec, vec3_t vec2);
 ...
 * determinant of mat
 */
__type mat4_determinant(mat4_t mat);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotate(mat4_t mat, __type angle, vec3_t axis, mat4_t dest);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotateX(mat4_t mat, __type angle, mat4_t dest);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotateY(mat4_t mat, __type angle, mat4_t dest);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotateZ(mat4_t mat, __type angle, mat4_t dest);
 ...
 * dest if not NULL, a new mat4_t otherwise
 */
mat4_t mat4_frustum(__type left, __type right, __type bottom, __type top, __type near, __type far, mat4_t dest);
 ...
 * dest if not NULL, a new mat4_t otherwise
 */
mat4_t mat4_perspective(__type fovy, __type aspect, __type near, __type far, mat4_t dest);
 ...
 * dest if not NULL, a new mat4_t otherwise
 */
mat4_t mat4_ortho(__type left, __type right, __type bottom, __type top, __type near, __type far, mat4_t dest);
 ...
 */
__type quat_dot(quat_t quat, quat_t quat2);
 ...
 * Length of quat
 */
__type quat_length(quat_t quat);
 ...
 * dest if not NULL, quat otherwise
 */
quat_t quat_slerp(quat_t quat, quat_t quat2, __type slerp, quat_t dest);
